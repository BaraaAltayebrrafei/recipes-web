<html>
    ...
    if (!(isset($_SESSION['islogin']) && $_SESSION['islogin'] == 1)) {
        ...
        echo "<br/><br/>";
        $query1 = "SELECT ID_RECIPES FROM comment_user WHERE ID_USER = $userId GROUP BY ID_RECIPES";
        ...
        else echo "<div class='no'>You don't have any commented recipes </div>";    
    }
    ?>
    </body>
</html>
